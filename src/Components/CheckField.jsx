...
export default function CheckField({ time, title, delEnable, deletion ,isChecked ,checkFieldChecked}) {
        ...
        >
          <Checkbox
            ...
            onChange={e => {
              ...
              checkFieldChecked([time, title,!checkedItem]);
            }}
            w="100%"
            pl="20px"
          >
